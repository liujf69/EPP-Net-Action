...
class Processor(IO):
    ...
    def init_environment(self):
        ...
        self.meta_info = dict(epoch=0, iter=0, is_best=False, best_t1=0.5)
                    ...
                    if True:
                        ...
                        result_dict = dict(
                            zip(self.data_loader['test'].dataset.sample_name,
                                self.result))
                        self.io.save_pkl(result_dict, 'test_result_epoch{}.pkl'.format(epoch+1))
    ...
    def get_parser(add_help=False):
        ...
        parser.add_argument('-c', '--config', default='./config/ntu120_xsub/train.yaml', help='path to the configuration file')
